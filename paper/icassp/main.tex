...
%
% ICASSP is single-blind: authors are named. Corresponding author unmarked ---
% add \thanks{...} on the author line for funding, and a School/Dept if desired.
\name{Hao Zhou, Hua Dai$^{\dagger}$, Letian Sha$^{\dagger}$, Geng Yang\thanks{$^{\dagger}$Corresponding authors.}}
\address{Nanjing University of Posts and Telecommunications, Nanjing, China}
...
release the harness and all raw results.% TODO(author): replace with a public URL before camera-ready.
\end{abstract}
